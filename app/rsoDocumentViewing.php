...
<body style="padding-top: 5px; margin-left: 20%;">
...
<button onclick="window.location.href='rsoEventHub.php';" class="btn btn-light d-flex justify-content-center align-items-center" 
    ...
    <div class="col-lg-7 d-flex align-items-stretch">
        <div class="rounded-container" style="background-color: #f9f9f9; border-radius: 15px; padding: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3); width: 100%; margin: 0 auto; height: 100%;">
            <form method="post" action="rsoEditProposal.php">
...
<div class="row" style="margin-top: 20px;"><h4>Project Lead Details</h4></div>
    ...
    <div class="col-4">
        <button type="submit" name="approve" class="btn btn-success btn-block" style="width: 100%;">Edit Proposal</button>
    </div>
<div class="col-4">
