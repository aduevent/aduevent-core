...
<body style="margin-left: 20%; padding-top: 5px;">
    ...
    <ul class="list-inline" style="margin-bottom: 10px;">
        ...
        <li class="list-inline-item">
            <button onclick="window.location.href='osaEventCalendar.php';"
    ...
    function addNote() {
        ...
        if (note) {
            ...
            window.location.href = `osaAddNote.php?date=<?php echo $clickedDate; ?>&note=${encodeURIComponent(note)}`;
        }
    }
</script>
</body>
