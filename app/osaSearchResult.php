...
<body style="margin-left: 20%; padding-top: 5px;">
    ...
    if ($events_result->num_rows > 0) {
        ...
        while ($event = $events_result->fetch_assoc()) {
            ...
            $buttonLink = ($event['eventStatus'] == 1) ? "osaDetailViewing.php?eventID=" . $event['eventID'] : "osaDocumentViewing2.php?eventID=" . $event['eventID'];
    ...
    if ($orgs_result->num_rows > 0) {
        ...
        while ($org = $orgs_result->fetch_assoc()) {
            ...
            $buttonLink = "osaRsoDashboard.php?organizationID=" . $org['organizationID'];
            ...
            echo "<tr style='border-bottom: 1px solid #ddd;'>
                    ...
                    <td style='text-align: right; padding: 10px;'>
                        <a href='$buttonLink'>
                            <button class='btn btn-primary' style='border-radius: 50%; padding: 10px 12px;'>
                                <i class='bi bi-eye'></i>
                            </button>
                        </a>
                    </td>
