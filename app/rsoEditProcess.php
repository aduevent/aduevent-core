...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (password_verify($pin, $hashedPin)) {
        if (isset($_POST['eventID'])) {
            ...
            $stmt->bind_param(
                "sssssssssddddssssssi", $activityTitle, $eventCategory, $venue, $venueType, $proposedDate, 
                $timeStart, $timeEnd, $orgFundAmount, $solShareAmount, $regFeeAmount, $ausgSubAmount, 
                $sponsorValue, $ticketSellingAmount, $controlNumber, $others, $participant, $organizationPartner, 
                $designation, $approvalMessage, $eventID
            );
            ...
            if ($recipientEmail) {
                ...
                try {
                    ...
                    $mail->Subject = 'Event Successful Modification Notification';
