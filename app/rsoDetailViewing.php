...
<body style="margin-left: 20%; padding-top: 5px;">
    ...
    $eventTimeFormatted = date(
        "g:iA",
        strtotime($eventDetails["eventTimeStart"])
    );

    echo '<div class="event-preview event-venue-' .
        $eventDetails["eventVenueCategory"] .
        '" style="padding-right: 20%;">';
    echo '<div class="event-background" style="background-image: url(\'' .
...
<?php
echo '<div class="rounded-rectangle white-background text-center" style="margin-top: 5px;">' .
    htmlspecialchars($venueText) .
    "</div>";

// Event Title
echo '<div class="row justify-content-center" style="margin-top: 10px;">';
echo '<div class="col text-center">';
echo '<b class="event-title">' .
    htmlspecialchars($eventDetails["eventTitle"]) .
    "</b>";
echo "</div>";
echo "</div>";
...
echo '<img class="organization-logo" src="' .
    htmlspecialchars($eventDetails["organizationLogo"]) .
    '" alt="Organization Logo">';
echo "</li>";
echo '<li class="list-inline-item">';
echo '<p class="organization-name">' .
    htmlspecialchars($eventDetails["organizationName"]) .
    "</p>";
echo "</li>";
echo "</ul>";
echo "</div>";
...
echo '<div class="col">';
echo '<div class="text-left event-description">' .
    htmlspecialchars($eventDetails["eventDescription"]) .
    "</div>";
echo "</div>";
echo "</div>";
...
echo '<div class="detail-item rounded-rectangle">' .
    htmlspecialchars($eventDetails["eventVenue"]) .
    "</div>";
echo "</div>";
echo '<div class="detail-item-container">';
