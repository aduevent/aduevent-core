...
<body style="margin-left: 20%; padding-top: 5px;">
    ...
    <ul class="list-inline" style="margin-bottom: 10px;">
        ...
        <li class="list-inline-item">
            <button onclick="window.location.href='rsoCalendarView.php';"
                    class="btn btn-secondary justify-content-center" 
        ...
        <?php
        $query = "SELECT eventID, eventTitle, eventDate, organizationName, eventVenueCategory 
        FROM event 
        INNER JOIN organization ON event.organizationID = organization.organizationID 
        WHERE eventStatus = '1' AND event.organizationID = '$orgId' 
        ...
        $result = mysqli_query($conn, $query);
            if (!$result) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<form action="rsoDetailViewing.php" method="GET">';
