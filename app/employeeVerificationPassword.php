...
$showOtpModal = true; // Show OTP modal initially
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($_POST['reset_password'])) {
        ...
        if ($password !== $confirmPassword) {
            ...
            if ($stmt->execute()) {
                echo '<script>alert("Password updated successfully!"); window.location.href = "loginEployee.php";</script>';
                session_destroy();
                exit();
            } else {
...
<body>
    <div class="container">
        <!-- OTP Modal -->
        <div id="otpModal" style="display: <?php echo $showOtpModal ? 'block' : 'none'; ?>;">
            <h3>Enter OTP</h3>
        ...
        <div id="resetPasswordModal" style="display: <?php echo $showResetPasswordModal ? 'block' : 'none'; ?>;">
