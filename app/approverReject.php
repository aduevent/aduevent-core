...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['eventID'])) {
    ...
    // Update the event table with the rejection message and status
    $updateQuery = "UPDATE event SET $signColumn = '$rejectionMessage', eventStatus = 2 WHERE eventID = $eventID";
    ...
    if ($updateResult) {
        ...
        if ($emailResult && mysqli_num_rows($emailResult) > 0) {
            ...
            try {
                ...
                $mail->Body    = "Hello $projectLeadName,<br><br>
                                 This is to notify you that you have rejected an event submitted by <strong>$orgName</strong> titled <strong>$eventName</strong> on <strong>$timestamp</strong>.<br><br>
                ...
                $mail->AltBody = "Hello $projectLeadName,\n\n
                                 This is to notify you that you have rejected an event submitted by $orgName titled $eventName on $timestamp.\n\n
        ...
        header("Location: approverEventRejection.php");
        exit();
    } else {
