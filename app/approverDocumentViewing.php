...
$activePage = "approverDocumentViewing";
...
<head>
    ...
    <title>Approver Document View</title>
...
<div class="container" style="margin-left: 5px;">
    <div class="row justify-content-center align-items-center">
        <div class="rounded-container d-flex justify-content-center align-items-center" style="background-color: #F9F9F9; border-radius: 25px; padding: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3); width: 90%; text-align: center;">
            <div style="display: flex; flex-direction: column; align-items: center;">
                ...
                <div style="font-size: .7em; color: #666; margin-top: 0; border-top: 1px solid #000;">
                    ...
                    switch ($eventCategory) {
                        case '1': echo 'Organizational Related'; break;
                        case '4': echo 'Environmental'; break;
                        case '5': echo 'Organizational Development'; break;
                        case '3': echo 'Spiritual Enrichment'; break;
                        case '2': echo 'Community Involvement'; break;
                        case '6': echo 'Others: ' . $otherEventCategory; break;
    ...
    <div class="col-lg-7 d-flex align-items-stretch">
        <div class="rounded-container" style="background-color: #f9f9f9; border-radius: 15px; padding: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3); width: 100%; margin: 0 auto; height: 100%;">
                <?php
                        $resultOrganization = mysqli_query($conn, "SELECT * FROM organization WHERE organizationID = '$organizationName'");
                        if ($resultOrganization) {
                            $row_org = mysqli_fetch_assoc($resultOrganization);
                            $organizationLogo = $row_org['organizationLogo'];
                            $organizationName = htmlspecialchars($row_org['organizationName']);
                            $organizationType = '';
                            switch ($orgType) {
                                case '1': $organizationType = 'Academic'; break;
                                case '2': $organizationType = 'Co-Academic'; break;
                                case '3': $organizationType = 'Socio-civic'; break;
                                case '4': $organizationType = 'Religious'; break;
                                case '5': $organizationType = 'College Council'; break;
                                case '6': $organizationType = 'AUSG'; break;
                                case '7': $organizationType = 'Chronicle'; break;
                                default: $organizationType = 'Unknown'; break;
                            }
            ...
            <ul class="list-inline" style="margin-top: 0;">
                ...
                <li class="list-inline-item"><?php echo date('h:i A', strtotime($timeStart)) . ' to ' . date('h:i A', strtotime($timeEnd)); ?></li>
            </ul>
            <ul class="list-inline" style="margin-top: 0;">
            ...
            <ul class="list-inline" style="margin-top: 0;">
                ...
                <?php
                    switch ($venueType) {
                        case '1': echo 'On-Campus'; break;
                        case '2': echo 'Off-Campus'; break;
    ...
    <div class="col-lg-5 d-flex align-items-stretch">
        <div class="rounded-container" style="background-color: #f9f9f9; border-radius: 15px; padding: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3); width: 100%; margin: 0 auto; height: 100%;">
            <ul class="list-inline" style="margin-top: 0;">
                ...
                <li class="list-inline-item"><?php echo $orgFundAmount ? 'Php ' .$orgFundAmount: 'N/A'; ?></li>
            </ul>
            <ul class="list-inline" style="margin-top: 0;">
                <li class="list-inline-item"><b>Solidarity Share:</b></li>
                <li class="list-inline-item"><?php echo $solShareAmount ? 'Php ' .$solShareAmount: 'N/A'; ?></li>
            </ul>
            <ul class="list-inline" style="margin-top: 0;">
                <li class="list-inline-item"><b>Registration Fee:</b></li>
                <li class="list-inline-item"><?php echo $regFeeAmount ? 'Php ' .$regFeeAmount: 'N/A'; ?></li>
            </ul>
            <ul class="list-inline" style="margin-top: 0;">
                <li class="list-inline-item"><b>AUSG Subsidy:</b></li>
                <li class="list-inline-item"><?php echo $ausgSubAmount ? 'Php ' .$ausgSubAmount: 'N/A'; ?></li>
            </ul>
            <ul class="list-inline" style="margin-top: 0;">
                <li class="list-inline-item"><b>Sponsorship:</b></li>
                <li class="list-inline-item"><?php echo $sponsorValue ? $sponsorValue: 'N/A'; ?></li>
            </ul>
            <ul class="list-inline" style="margin-top: 0;">
                <li class="list-inline-item"><b>Ticket Selling:</b></li>
                <li class="list-inline-item"><?php echo $ticketSellingAmount ? 'Php ' .$ticketSellingAmount: 'N/A'; ?></li>
            </ul>
            <ul class="list-inline" style="margin-top: 0;">
                <li class="list-inline-item"><b>Control Number:</b></li>
                <li class="list-inline-item"><?php echo $controlNumber ? $controlNumber: 'N/A'; ?></li>
            </ul>
            <ul class="list-inline" style="margin-top: 0;">
                <li class="list-inline-item"><b>Others:</b></li>
                <li class="list-inline-item"><?php echo $others ? $others : 'N/A'; ?></li>
            </ul>
        </div>
    </div>
</div>
<div class="row" style="margin-top: 20px;"><h4>Project Lead Details</h4></div>
    <div class="rounded-container" style="background-color: #f9f9f9; border-radius: 15px; padding: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3); width: 100%; margin: 0 auto;">
        <div class="row text-center">
            <div class="col-4">
                <?php echo !empty($leadSign) ? "<p style='margin-bottom: 0;'>$leadSign</p>" : "<p style='margin-bottom: 0;'>N/A</p>"; ?>
            </div>
            <div class="col-4">
                <?php echo !empty($designation) ? "<p style='margin-bottom: 0;'>$designation</p>" : "<p style='margin-bottom: 0;'>N/A</p>"; ?>
            </div>
            <div class="col-4">
                <p style="margin-bottom: 0;"><?php echo !empty($submissionDate) ? $submissionDate : 'N/A'; ?></p>
            </div>
        </div>
        <div class="row text-center">
            <div class="col-4">
    ...
    <div class="row" style="margin-top: 20px;"><h4>Approval Section</h4></div>
        <div class="rounded-container" style="background-color: #f9f9f9; border-radius: 15px; padding: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3); width: 100%; margin: 0 auto;">
            <div class="row text-center">
                <div class="col-4">
                    <div class="signature-box">
                        <?php echo !empty($adviserSign) ? "<p style='margin-bottom: 0;'>$adviserSign</p>" : ''; ?>
                    </div>
            ...
            <?php if ($orgType == 1): ?>
                <div class="col-4">
                    <div class="signature-box">
                        <?php echo !empty($chairpersonSign) ? "<p style='margin-bottom: 0;'>$chairpersonSign</p>" : ''; ?>
                    </div>
                    <label for="chairpersonSign" style="font-size: 0.7em; margin-top: 0; border-top: 1px solid #000;">College Chairperson</label>
                </div>
                <div class="col-4">
                    <div class="signature-box">
                        <?php echo !empty($deanSign) ? "<p style='margin-bottom: 0;'>$deanSign</p>" : ''; ?>
                    </div>
        ...
        <div class="row text-center">
            <?php if ($eventCategory == 2): ?>
                <div class="col-6">
                    <div class="signature-box">
                        <?php echo !empty($icesSign) ? "<p style='margin-bottom: 0;'>$icesSign</p>" : ''; ?>
                    </div>
            ...
            <?php elseif ($eventCategory == 3): ?>
                <div class="col-6">
                    <div class="signature-box">
                        <?php echo !empty($ministrySign) ? "<p style='margin-bottom: 0;'>$ministrySign</p>" : ''; ?>
                    </div>
        ...
        <div class="row text-center">
            <div class="col-6">
                <div class="signature-box">
                    <?php echo !empty($sdsSign) ? "<p style='margin-bottom: 0;'>$sdsSign</p>" : ''; ?>
                </div>
                <label for="sdsSign" style="font-size: 0.7em; margin-top: 0; border-top: 1px solid #000;">Student Development Section</label>
            </div>
            <div class="col-6">
                <div class="signature-box">
                    <?php echo !empty($osaSign) ? "<p style='margin-bottom: 0;'>$osaSign</p>" : ''; ?>
                </div>
        ...
        <div class="row text-center">
            <?php if ($venueType == 2): ?>
                <div class="col-6">
                    <div class="signature-box">
                        <?php echo !empty($vpsaSign) ? "<p style='margin-bottom: 0;'>$vpsaSign</p>" : ''; ?>
                    </div>
                    <label for="vpsaSign" style="font-size: 0.7em; margin-top: 0; border-top: 1px solid #000;">Vice President for Student Affairs</label>
                </div>
            <?php endif; ?>
            <?php if (!empty($ticketSellingAmount) || !empty($sponsorValue) || !empty($regFeeAmount)): ?>
                <div class="col-6">
                    <div class="signature-box">
                        <?php echo !empty($vpfaSign) ? "<p style='margin-bottom: 0;'>$vpfaSign</p>" : ''; ?>
                    </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <?php if (empty($adviserSign) && $_SESSION['access'] == 3): ?>
                <div class="col-4">
                    <button type="submit" name="approve" class="btn btn-success btn-block" style="width: 100%;" onclick="showPinModal(event)">Approve as Adviser</button>
                </div>
            <?php endif; ?>
            <?php if (empty($chairpersonSign) && $_SESSION['access'] == 4): ?>
                <div class="col-4">
                    <button type="submit" name="approve" class="btn btn-success btn-block" style="width: 100%;" onclick="showPinModal(event)">Approve as Chairperson</button>
                </div>
            <?php endif; ?>
            <?php if (empty($deanSign) && $_SESSION['access'] == 7): ?>
                <div class="col-4">
                    <button type="submit" name="approve" class="btn btn-success btn-block" style="width: 100%;" onclick="showPinModal(event)">Approve as College Dean</button>
                </div>
            <?php endif; ?>
            <?php if (empty($sdsSign) && $_SESSION['access'] == 8): ?>
                <div class="col-4">
                    <button type="submit" name="approve" class="btn btn-success btn-block" style="width: 100%;" onclick="showPinModal(event)">Approve as Student Development Section</button>
                </div>
            <?php endif; ?>
            <?php if (empty($icesSign) && $_SESSION['access'] == 9): ?>
                <div class="col-4">
                    <button type="submit" name="approve" class="btn btn-success btn-block" style="width: 100%;" onclick="showPinModal(event)">Approve as ICES</button>
                </div>
            <?php endif; ?>
            <?php if (empty($ministrySign) && $_SESSION['access'] == 10): ?>
                <div class="col-4">
                    <button type="submit" name="approve" class="btn btn-success btn-block" style="width: 100%;" onclick="showPinModal(event)">Approve as Ministry</button>
                </div>
            <?php endif; ?>
            <?php if (empty($vpsaSign) && $_SESSION['access'] == 11): ?>
                <div class="col-4">
                    <button type="submit" name="approve" class="btn btn-success btn-block" style="width: 100%;" onclick="showPinModal(event)">Approve as VPSA</button>
                </div>
            <?php endif; ?>
            <?php if (empty($vpfaSign) && $_SESSION['access'] == 12): ?>
                <div class="col-4">
    <button type="submit" name="approve" class="btn btn-success btn-block" style="width: 100%;" onclick="showPinModal(event)">Approve as VPFA</button>
</div>
<?php endif; ?>
<?php if (!empty($leadSign) || !empty($adviserSign) || !empty($chairpersonSign) || !empty($deanSign) || !empty($icesSign) || !empty($ministrySign) || !empty($vpsaSign) || !empty($vpfaSign)): ?>
    <div class="col-4">
...
<?php endif; ?>
<div class="col-4">
    <button type="button" class="btn btn-danger btn-block" style="width: 100%;" onclick="showRejectPinModal(event)">Reject</button>
</div>
</div>
</div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="approvalProcess.php" method="POST">
                    <input type="hidden" name="projectLeadName" value="<?php echo htmlspecialchars($userName); ?>">
...
<div class="modal fade" id="rejectPinModal" tabindex="-1" role="dialog" aria-labelledby="rejectPinModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="rejectionProcess.php" method="POST">
...
<div class="modal fade" id="commentModal" tabindex="-1" role="dialog" aria-labelledby="commentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header justify-content-center">
                <h5 class="modal-title text-center">
                    <div class="small text-center">Comment Section</div>
                </h5>
            </div>
            <div class="modal-body">
                <?php
                ...
                $query = "SELECT name, comment, createdAt FROM eventcomments WHERE eventID = ? ORDER BY createdAt DESC";
                ...
                if ($stmt = $conn->prepare($query)) {
                    ...
                    while ($stmt->fetch()) {
                        echo '<div class="mb-1">';
                        echo '<strong>' . htmlspecialchars($name) . ':</strong> ' . htmlspecialchars($comment) . '<br>';
                        echo '<small class="text-muted">' . date('Y-m-d H:i', strtotime($createdAt)) . '</small>';
                        echo '</div>';
                    }
                    $stmt->close();
                } else {
                ...
                $conn->close();
                ?>
                <form method="post" action="approverAddComment.php">
                    <input type="hidden" id="projectLeadName" name="projectLeadName" value="<?php echo htmlspecialchars($userName); ?>">
                    ...
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-primary approve-btn">Comment</button>
                    </div>
                </form>
            </div>
        </div>
