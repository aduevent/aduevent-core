...
if (isset($_POST['verify_password_otp'])) {
    ...
    if ($enteredOtp == $_SESSION['change_password_otp']) {
        ...
        if ($stmt->execute()) {
            echo "<script>
                    ...
                    window.location.href = 'adminProfileViewing.php';
                  </script>";
        } else {
    ...
    window.location.href = 'adminProfileViewing.php?otpSent=true';
</script>";}
}
    ...
    if ($newPassword === $confirmNewPassword) {
        ...
        if ($recipientEmail) {
            ...
            try {
                ...
                $mail->send();
                header("Location: adminProfileViewing.php?otpSent=true");
        exit;
            } catch (Exception $e) {
