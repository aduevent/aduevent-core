    ...
    if (isset($_POST['verify_otp'])) {
        ...
        if ($enteredOtp == $_SESSION['otp']) {
            ...
            if ($stmt->execute()) {
                ...
                window.location.href = 'approverProfileViewing.php';</script>";
            } else {
        ...
        window.location.href = 'approverProfileViewing.php'; // Redirect to the specified page
    </script>";
        }
    }
        else {
...
<head>
    ...
    $activePage = "approverChangePinProcess";?>
</head>
