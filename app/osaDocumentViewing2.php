...
<button onclick="window.location.href='osaEventApproval.php';" class="btn btn-light d-flex justify-content-center align-items-center" 
    ...
    <div class="row justify-content-center align-items-center">
        <div class="rounded-container d-flex justify-content-center align-items-center" style="background-color: #F9F6EE; margin-top: 8px; border-radius: 25px; padding: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); width: 90%; text-align: center;">
    ...
    <div class="col-lg-7 d-flex align-items-stretch">
        <div class="rounded-container" style="background-color: #F9F6EE; border-radius: 15px; padding: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); width: 100%; margin: 0 auto; height: 100%;">
...
<div class="row" style="margin-top: 20px;"><h4>Project Lead Details</h4></div>
    <div class="rounded-container" style="background-color: #F9F6EE; border-radius: 15px; padding: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); width: 100%; margin: 0 auto;">
