...
if (isset($_POST['verify_password_otp'])) {
    ...
    if ($enteredOtp == $_SESSION['change_password_otp']) {
        ...
        if ($stmt->execute()) {
            echo "<script>
                    ...
                    window.location.href = 'approverIndex.php';
                  </script>";
        } else {
    ...
    window.location.href = 'approverProfileViewing.php?otpSent=true';
</script>";
    }
}
elseif (isset($_POST['change_password'])) {
    ...
    if ($newPassword === $confirmNewPassword) {
        ...
        if ($recipientEmail) {
            ...
            try {
                ...
                $mail->send();
                header("Location: approverProfileViewing.php?otpSent=true");
        exit;
            } catch (Exception $e) {
    ...
    window.location.href = 'approverProfileViewing.php';
</script>";}
}
} else {
    echo "<script>
