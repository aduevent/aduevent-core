...
if (isset($_GET['categoryID']) && isset($_GET['academicYear']) && isset($_GET['organizationID'])) {
    $categoryID = $_GET['categoryID'];
    $academicYear = $_GET['academicYear'];
    $currentOrgID = $_GET['organizationID'];
    ...
    $sql = "SELECT eventTitle, eventDate, eventID FROM event 
            ...
            AND organizationID = $currentOrgID
    ...
    // Add the button group with inline CSS for right alignment and white fill for the button
